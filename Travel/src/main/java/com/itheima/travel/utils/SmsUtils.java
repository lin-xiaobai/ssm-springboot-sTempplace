...
public class SmsUtils {
     ...
     */
    private static String accessKeyId = "LTAI5tKetWgJNVCbjfpKekPB";
    private static String accessKeySecret = "T3v79kL0Hi9DLHwRydahSeeGFYFXEP";
    ...
    public static void main(String[] args) {
        String code = SmsUtils.send("13202561957", "黑马旅游", "SMS_195723031", "123456");
